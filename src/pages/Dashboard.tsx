...
const ECO_FACTS = [
  {
    category: "Energy",
    text: "Switching just one 60-watt incandescent light bulb to an LED saves about 160 kg of CO₂ per year and reduces electricity costs significantly."
  },
  {
    category: "Waste",
    text: "If food waste were a country, it would be the third-largest emitter of greenhouse gases globally, trailing only China and the United States."
  },
  {
    category: "Energy",
    text: "Vampire energy—the electricity consumed by appliances when turned off but plugged in—can account for up to 10% of an average home's utility bills."
  },
  {
    category: "Recycling",
    text: "Recycling a single aluminium can saves enough energy to power a television for up to three hours compared to extracting and smelting virgin materials."
  },
  {
    category: "Water",
    text: "It takes approximately 2,700 liters of freshwater to produce a single organic cotton t-shirt—enough water for one person to drink for 2.5 years."
  },
  {
    category: "Climate",
    text: "While peatlands cover only 3% of the world's land surface, they store twice as much carbon as all of the world's forests combined."
  },
  {
    category: "Digital Footprint",
    text: "An average promotional email produces 0.3g of CO₂e, a standard email emits 4g, and a large attachment can produce up to 50g of CO₂e."
  },
  {
    category: "Water",
    text: "A faucet leaking at a rate of one drip per second can waste more than 11,000 liters of water a year—equivalent to over 180 standard showers."
  },
  {
    category: "Recycling",
    text: "Recycling 1 ton of paper saves 17 trees, 26,500 liters of water, 2.3 cubic meters of landfill space, and 4,000 kilowatt-hours of electricity."
  },
  {
    category: "Diet",
    text: "Producing 1 kg of beef creates around 60 kg of greenhouse gases (CO₂e), whereas producing 1 kg of tofu creates less than 3 kg of emissions."
  },
  {
    category: "Plastic",
    text: "A single lightweight plastic bag has an average active working life of only 12 minutes, but it can take up to 500 years to decompose in a landfill."
  },
  {
    category: "Climate",
    text: "The world's oceans absorb around 30% of human-made CO₂ emissions and over 90% of the excess heat generated by global greenhouse gases."
  },
  {
    category: "Flora",
    text: "Bamboo is the fastest-growing woody plant on Earth. Some species grow up to 91 cm in a single day, and they release 35% more oxygen than trees."
  },
  {
    category: "Recycling",
    text: "Glass is 100% recyclable and can be recycled endlessly with zero loss in quality. Recycling glass saves 30% of the energy needed for new glass."
  },
  {
    category: "Diet",
    text: "By eating fully plant-based food for just one day a week, you save approximately 1,500 liters of water and reduce emissions by over 3.5 kg of CO₂."
  },
  {
    category: "Flora",
    text: "A single mature tree can absorb more than 22 kg of carbon dioxide per year and release enough life-supporting oxygen to support two adult humans."
  },
  {
    category: "Water",
    text: "Reducing your daily shower time by just two minutes can save up to 45 liters of water and reduce your hot water heating energy bills by 10%."
  },
  {
    category: "Energy",
    text: "Leaving a phone charger plugged into the wall when not in use still draws active phantom power, which adds up to tons of emissions globally."
  },
  {
    category: "Energy",
    text: "Lowering your home temperature by just 1°C in winter can reduce your heating energy bills and space climate footprint by up to 10%."
  },
  {
    category: "Transport",
    text: "Properly inflating your vehicle's tires improves fuel efficiency by up to 3%. This simple habit saves about 50 kg of CO₂ emissions annually per driver."
  },
  {
    category: "Waste",
    text: "Globally, over 500 billion disposable coffee cups are used each year. Most are lined with plastic, making them virtually impossible to recycle standardly."
  },
  {
    category: "Energy",
    text: "About 75% to 90% of the energy your washing machine uses goes entirely toward heating the water. Switching to cold wash cycle reduces greenhouse gases significantly."
  },
  {
    category: "Transport",
    text: "The average plate of food in industrialized nations travels between 1,500 and 2,500 miles from farm to fields to table, generating high freight emissions."
  },
  {
    category: "Digital Footprint",
    text: "Every single search query produces about 0.2g of CO₂. With billions of daily searches, using renewable energy powered search tools makes an impact."
  },
  {
    category: "Plastic",
    text: "Using a reusable water bottle for one year saves an average of 156 disposable plastic bottles from ending up in our oceans and landfills."
  },
  {
    category: "Climate",
    text: "Global restoration of degraded lands could capture up to two-thirds of all human-made carbon emissions currently in the atmosphere."
  },
  {
    category: "Recycling",
    text: "One ton of recycled smartphones contains about 300 times more gold than a ton of gold ore, highlighting the power of circular tech recycling."
  },
  {
    category: "Energy",
    text: "Every single hour, the sun beams enough solar energy onto our planet to satisfy global energy demands for an entire year."
  },
  {
    category: "Climate",
    text: "Grasslands store up to 30% of the world's soil carbon. Because they store carbon underground in deep root systems, they are highly resilient to wildfires."
  },
  {
    category: "Biodiversity",
    text: "Although tropical rainforests cover less than 7% of the Earth's total land area, they are home to more than half of the world's plant and animal species."
  },
  {
    category: "Energy",
    text: "A single modern offshore wind turbine can produce enough electricity to power more than 8,000 households for a whole year."
  },
  {
    category: "Waste",
    text: "If every household went paperless for their utility bills, it would save over 18 million trees and prevent tons of waste annually."
  },
  {
    category: "Diet",
    text: "Buying locally grown foods reduces regional shipping emissions, supports biodiversity, and helps preserve local open space and agricultural communities."
  }
];
...
function EcoFact() {
  const dayIndex = useMemo(() => {
    ...
    // Use days since epoch to calculate index
    return Math.floor(today.getTime() / (1000 * 60 * 60 * 24)) % ECO_FACTS.length;
  }, []);

  const fact = ECO_FACTS[dayIndex];

  const [liked, setLiked] = useState(() => {
    try {
      const saved = localStorage.getItem(`eco_fact_liked_${dayIndex}`);
      return saved === "true";
    } catch {
      return false;
    }
  ...
  const toggleLike = () => {
    ...
    setLiked(nextLiked);
    try {
      localStorage.setItem(`eco_fact_liked_${dayIndex}`, String(nextLiked));
    } catch (e) {
  ...
  return (
    <Card className="bg-gradient-to-br from-[#F0FDF4] to-white border border-green-100 rounded-3xl p-6 shadow-sm relative overflow-hidden mt-6">
       ...
       <div className="relative z-10 flex flex-col md:flex-row gap-6 items-center justify-between">
          <div className="flex items-start gap-4">
            ...
            <div>
               <p className="text-[10px] font-bold text-green-700 uppercase tracking-widest mb-1">
                 Eco Fact of the Day • <span className="text-[#1B5E20]">{fact.category}</span>
               </p>
          ...
          <button 
            onClick={toggleLike} 
            className={`shrink-0 flex items-center justify-center gap-2 px-4 py-2 rounded-full border transition-all ${liked ? 'bg-red-50 border-red-200 text-red-500 font-semibold' : 'bg-white border-slate-200 text-slate-400 hover:bg-slate-50'}`}
          >
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-4">
        <div>
          <h1 className="font-heading text-3xl font-extrabold tracking-tight text-slate-900">🌍 Climate Twin Report</h1>
        ...
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 relative">
              <div className="bg-[#1B5E20] text-white p-6 rounded-3xl shadow-sm relative overflow-hidden flex flex-col justify-center">
                 ...
                 <h3 className="font-heading text-white/85 font-black text-sm tracking-widest uppercase mb-1">If You Continue Habits</h3>
              ...
              <div className="bg-emerald-50 border border-emerald-100 p-6 rounded-3xl shadow-sm flex flex-col justify-center">
                 <h3 className="font-heading text-emerald-800 font-extrabold text-sm tracking-widest uppercase mb-1">If You Complete Goals</h3>
            ...
            <div className="bg-indigo-50 border border-indigo-100 rounded-3xl p-6 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
               <div className="flex-1">
                 <div className="flex items-center gap-2 mb-2">
                   ...
                   <h3 className="font-heading text-sm font-bold text-indigo-900 uppercase tracking-widest">AI Prediction</h3>
                 </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 auto-rows-auto lg:min-h-[600px]">
              ...
              <Card className="lg:col-span-6 lg:row-span-6 bg-white border border-slate-200 rounded-3xl p-6 shadow-sm overflow-hidden flex flex-col relative">
                 <div className="flex justify-between items-center mb-6">
                    <div>
                      <h2 className="font-heading text-lg font-bold text-slate-800">Emission Breakdown</h2>
              ...
              <Card className="lg:col-span-3 lg:row-span-3 bg-white border border-slate-200 rounded-3xl p-6 flex flex-col shadow-sm max-h-[350px] overflow-y-auto hidden-scrollbar relative">
                 ...
                 <div className="flex-1 flex flex-col relative">
                    <h3 className="font-heading text-lg font-bold text-slate-800 leading-tight mb-2">{highlightReco}</h3>
              ...
              <Card className="lg:col-span-3 lg:col-start-1 lg:row-start-4 lg:row-span-3 bg-white border border-slate-200 rounded-3xl flex flex-col shadow-sm p-6 justify-between text-slate-900">
                 <div>
                    <h2 className="font-heading text-lg font-bold flex items-center gap-2 mb-1">
                       Future Projection
                    </h2>
                    <p className="text-xs text-slate-500">Simulate: Flights per year</p>
                 </div>
                 <div className="py-4">
                 ...
                 <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100">
                    <div className="flex justify-between items-center mb-1">
                       <p className="text-[10px] uppercase font-bold text-slate-500 tracking-wider">Projected Score</p>
                       <span className="text-xs text-[#16A34A] font-bold bg-green-50 px-2 py-0.5 rounded-full">LIVE</span>
                    </div>
                    <p className="text-3xl font-black text-slate-900">
                      <AnimatedNumber value={simulatedScore} />
                    </p>
                    <p className="text-xs text-slate-400 mt-1">If reduced from origin</p>
                 </div>
              </Card>
              ...
              <Card className="lg:col-span-3 lg:col-start-10 lg:row-start-4 lg:row-span-3 bg-[#1B5E20] rounded-3xl p-6 shadow-md text-white flex flex-col justify-between overflow-hidden relative">
                 ...
                 <div className="relative z-10 flex-1">
                    <div className="flex justify-between items-start mb-4">
                       <h2 className="font-heading text-[10px] font-bold text-green-300 uppercase tracking-widest mb-1">Weekly Mission</h2>
                       <Target className="h-4 w-4 text-green-300" />
                    </div>
                    <p className="font-heading text-xl font-bold leading-tight mb-4">Reduce transport emissions by 5%</p>
                 </div>
